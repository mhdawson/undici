...
const WASM_BUILDER_CONTAINTER = 'ghcr.io/mhdawson/wasm-builder@sha256:9acf5e23a11a30f3a7c37b3102d4438a49fddf76f40135ba9e6367e1428b75ab' // v0.0.5
...
if (process.argv[2] === '--docker') {
  ...
  cmd += ` --mount type=bind,source=${ROOT}/lib/llhttp,target=/home/node/build/lib/llhttp \
           ...
           -t ${WASM_BUILDER_CONTAINTER} node build/wasm.js`
  console.log(`> ${cmd}\n\n`)
